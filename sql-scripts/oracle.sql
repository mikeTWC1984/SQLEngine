...
---- SCHEDULED Event list
 ...
 SELECT  t.id, t.enabled enabled, t.title, t.category AS catid, t.plugin AS plugid, t.target, t.timezone
   ...
   , to_date('1970-01-01 00:00:00', 'yyyy-mm-dd hh24:mi:ss') + created/24/3600 AS created
   , to_date('1970-01-01 00:00:00', 'yyyy-mm-dd hh24:mi:ss') + modified/24/3600 AS updated
